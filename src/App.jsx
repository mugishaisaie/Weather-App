...
class App extends React.Component{
  // state hook
  state= {location:'',
    isLoading: false, displayLocation: "", 
  weather: {}};
  ...
  fetchWeather = async()=>{
    ...
    try {
      ...
      this.setState(weatherData.daily);
    } catch (err) {
      console.err(err);
    }finally{
  ...
  render(){
    return(
      ...
      <div>
       <Input onchange={this.state.location}
...
class Input extends React.Component{
  render(){
    return  <input type="text" placeholder="Search From Location...." value={this.props.location} onChange={this.props.setLocation} />
  }
}
